  ...
  <q-dialog ref="dialog" @hide="onDialogHide">
    <q-card class="q-dialog-import-data">
      <q-card-section>
        ...
        <q-file outlined v-model="importFile" ref="importFile" label="Import File" accept=".zip,.json,application/zip,application/json" @input="importError = false" @rejected="onRejected" :error="importError" error-message="Please select a supported file type.">
